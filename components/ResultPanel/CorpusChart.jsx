...
const CorpusChart = ({ results, inputs, hasError }) => {
    ...
    if (active && payload && payload.length) {
      return (
        <div className="bg-white p-3 border border-gray-200 shadow-md rounded text-sm">
          <p className="font-bold text-gray-800 mb-1">Age: {label}</p>
  ...
  return (
    <div className="w-full">
      ...
      <div className="h-[350px] w-full" role="img" aria-label="Line chart showing corpus accumulation during working years and depletion during retirement.">
        <ResponsiveContainer width="100%" height="100%">
          ...
          >
            ...
            <XAxis 
              dataKey="age" 
              tick={{fill: '#6b6a6a', fontSize: 12}}
              tickLine={false}
              axisLine={false}
              label={{ value: 'Age (Years)', position: 'insideBottom', offset: -10, fill: '#6b6a6a', fontSize: 13 }}
            />
            <YAxis 
